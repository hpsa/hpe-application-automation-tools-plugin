...
public class MqmRestClientImpl extends AbstractMqmRestClient implements MqmRestClient {
    ...
    public JSONObject postTest(String uftTestJson, HashMap<String, String> uftTestData, String serverURL) throws UnsupportedEncodingException {
        long createdTestId = 0;
        HttpPost request = new HttpPost(serverURL + "/tests");
        request.setHeader(HTTP.CONTENT_TYPE, "application/json");
        request.setHeader("Accept", "application/json");
        String description = "description";
        String content = "contentcontentcontentcontentcontent";
...
//				"            \"testing_tool_type\": {\n" +
//				"                \"type\": \"list_node\",\n" +
//				"                \"logical_name\": \"list_node.testing_tool_type.uft\",\n" +
//				"                \"name\": \"UFT\",\n" +
//				"                \"index\": 4,\n" +
//				"                \"id\": \"1075\"\n" +
//				"            },\n" +
...
//				"}";
    ...
    public void attachUFTParametersToTest(String testId, String resourceMtrAsJSON, String serverURL) throws UnsupportedEncodingException {
        ...
        try {
            ...
            String json = IOUtils.toString(response.getEntity().getContent());
            JSONObject jsonObject = JSONObject.fromObject(json);
//			return ((JSONArray)jsonObject.get("data")).getJSONObject(0).getLong("id");
//			return ((JSONArray)jsonObject.get("data")).getJSONObject(0).getLong("id");
