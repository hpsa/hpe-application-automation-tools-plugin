...
function octane_job_configuration(target, progress, proxy) {
    ...
    function renderConfiguration(jobConfiguration, pipelineId, instanceId) {
        ...
        function renderPipelineMetadata(pipeline, pipelineSelector) {
            ...
            //  NAME
            if (pipeline.isRoot) {
                var tdPipelineInput = $("<td class='setting-main' colspan='2'><input id='pipeline-name' type='text' placeholder='Pipeline name' class='jenkins-input' maxlength='50'/><div class='validation-error-area'/></td>");
        ...
        function renderExistingPipeline(pipeline, pipelineSelector) {
            ...
            function addField(field) {
                ...
                if (field.extensible) {
                    ...
                    var newValueInput = $("<input type='text' class='jenkins-input' maxlength='70' style ='width: 150px;'>");
            ...
            var tagTypeInput = $("<input type='text' class='jenkins-input'>");
            ...
            var tagInput = $("<input type='text' class='jenkins-input'>");
