<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="/">
        <testsuites disabled="" errors=""  failures="" name="{Report/Doc/DName}" tests=""  time="" >
    </testsuites>
                ...
                <tr>
                    <td bgcolor="white">
                        ...
                        <table border="0" cellpadding="3" cellspacing="0" width="100%">
                            <tr>
                                <td width="50%" valign="middle" align="center" class="tablehl">
                                    <b>
                                        <span class="tablehl">
                                            <xsl:copy-of select="$IDS_OUTPUT_PARAMETERS"/>
                                        </span>
                                    </b>
                                </td>
                                <td width="50%" valign="middle" align="center" class="tablehl">
    ...
    <xsl:template match="Step">
        <testcase name= {<xsl:value-of select="NodeArgs/Disp"/>}
        ...
        <xsl:element name="span">
            <xsl:value-of select="NodeArgs/@status"/>High
            </xsl:attribute>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
    <tr>
        <td class="iteration_head">
            <xsl:copy-of select="$IDS_ACTION_COLON"/>
            <xsl:value-of select="NodeArgs/Disp"/>
        </td>
    </tr>
    <tr>
                                            ...
                                            <tr>
                                                <td align="left" valign="top">
                                                    <p>
                                                        <b>
                                                            <span class="hl1">
                                                                <xsl:copy-of select="$IDS_ITERATION"/>
                                                                <xsl:value-of select="@iterID"/>
                                                                <xsl:copy-of select="$IDS_SUMMARY_COLON"/>
                                                            </span>
                                                        </b>
                                                    </p>
                                                </td>
                                                                ...
                                                                <td valign="middle" align="center" height="20">
                                                                    <span class="text">
                                                                        <xsl:choose>
                                                                            ...
                                                                            <xsl:otherwise>
                                                                                <xsl:value-of select="Summary/@sTime"/>
                                                                            </xsl:otherwise>
                                                                        </xsl:choose>
                                                                    </span>
                                                                </td>
                            ...
                            <table border="0" cellpadding="3" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td height="30">
                                        ...
                                        <b>
                                            <span class="hl1">
                                                <xsl:copy-of select="$IDS_RESULTS_SUMMARY"/>
                                            </span>
                                        </b>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        <span class="text">
                                            <b>
                                                <xsl:copy-of select="$IDS_RUN_STARTED_COLON"/>
                                            </b>
                                            <xsl:value-of select="Summary/@sTime"/>
                                        </span>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <span class="text">
                                            <b>
                                                <xsl:copy-of select="$IDS_RUN_ENDED_COLON"/>
                                            </b>
                                            <xsl:value-of select="Summary/@eTime"/>
                                        </span>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>
                                        <span class="text">
                                            <b>
                                                <xsl:copy-of select="$IDS_RESULT_COLON"/>
                                            </b>
                                            <xsl:value-of select="NodeArgs/@status"/>
                                        </span>
                                    </td>
                                            ...
                                            <tr>
                                                <td width="50%" valign="middle" align="center" height="20">
                                                    <span class="warning">
                                                        <span class="text">
                                                            <b>
                                                                <xsl:copy-of select="$IDS_WARNINGS"/>
                                                            </b>
                                                        </span>
                                                    </span>
                                                </td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td class="iteration_head">
            <xsl:copy-of select="$IDS_TEST_ITERATION"/>
            <xsl:value-of select="@iterID"/>
        </td>
    </tr>
    <tr>
                                ...
                                <td bgcolor="white">
                                    <table border="0" cellpadding="3" cellspacing="0" width="100%">
                                        <tr>
                                            <td valign="middle" align="center" class="tablehl">
                                                <span class="tablehl">
                                                    <xsl:copy-of select="$IDS_OBJECT_TAB"/>
                                                </span>
                                            </td>
                                            <td valign="middle" align="center" class="tablehl">
                                                <span class="tablehl">
                                                    <xsl:copy-of select="$IDS_DETAILS_TAB"/>
                                                </span>
                                            </td>
                                            <td valign="middle" align="center" class="tablehl">
                                                <span class="tablehl">
                                                    <xsl:copy-of select="$IDS_RESULT_TAB"/>
                                                </span>
                                            </td>
                                            <td valign="middle" align="center" class="tablehl">
                                                <span class="tablehl">
                                                    <xsl:copy-of select="$IDS_TIME_TAB"/>
                                                </span>
                                            </td>
                                        </tr>
                                        <tr>
...
<xsl:choose>
    <xsl:when test="@type = 'BC'">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td class="iteration_head" bgcolor="gray">
                    <xsl:copy-of select="$IDS_BC"/>
                    <xsl:value-of select="DName"/>
                    <xsl:if test="@BCIter">(Iteration<xsl:value-of select="@BCIter"/>)
                    </xsl:if>
                </td>
            </tr>
            <tr>
...
<table border="0" cellpadding="3" cellspacing="0" width="100%">
        ...
        <td>
            <span class="text">
                <b>
                    <xsl:choose>
                        <xsl:when test="@type = 'BC'">
                            <xsl:copy-of select="$IDS_BC_COLON"/>
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:copy-of select="$IDS_TEST_COLON"/>
                        </xsl:otherwise>
                    </xsl:choose>
                </b>
                <xsl:value-of select="DName"/>
    ...
    <xsl:if test="@productName">
        <tr>
            <td>
                <span class="text">
                    <b>
                        <xsl:copy-of select="$IDS_PRODUCT_NAME_COLON"/>
                    </b>
    ...
    <tr>
        <td>
            <span class="text">
                <b>
                    <xsl:copy-of select="$IDS_RESULTS_NAME_COLON"/>
                </b>
    ...
    <tr>
        <td>
            <span class="text">
                <b>
                    <xsl:copy-of select="$IDS_TIME_ZONE_COLON"/>
                </b>
                <xsl:value-of select="//Report/@tmZone"/>
            </span>
        </td>
    </tr>
    <tr>
    ...
    <xsl:if test="DVer">
        <tr>
            <td>
                <span class="text">
                    <b>
                        <xsl:copy-of select="$IDS_TEST_VER_COLON"/>
                    </b>
                    <xsl:value-of select="DVer"/>
                </span>
            </td>
        </tr>
    </xsl:if>
    <xsl:if test="TSet">
        <tr>
            <td>
                <span class="text">
                    <b>
                        <xsl:copy-of select="$IDS_TEST_SET_COLON"/>
                    </b>
                    <xsl:value-of select="TSet"/>
                </span>
            </td>
        </tr>
    </xsl:if>
    <xsl:if test="TInst">
        <tr>
            <td>
                <span class="text">
                    <b>
                        <xsl:copy-of select="$IDS_TEST_INSTANCE_COLON"/>
                    </b>
                        ...
                        <td bgcolor="white">
                            <table border="0" cellpadding="2" cellspacing="0" width="100%">
                                <tr>
                                    <td width="50%" valign="middle" align="center" class="tablehl">
                                        <span class="tablehl">
                                            <xsl:copy-of select="$IDS_ITERATION_NUMBER"/>
                                        </span>
                                    </td>
                                    <td width="50%" valign="middle" align="center" class="tablehl">
                                        <span class="tablehl">
                                            <xsl:copy-of select="$IDS_RESULTS"/>
                                        </span>
                                    </td>
                                </tr>
                                <tr>
...
<table border="0" cellpadding="3" cellspacing="0" width="100%">
    ...
    <tr>
        <td>
            <span class="text">
                <b>
                    <xsl:copy-of select="$IDS_BPT_COLON"/>
                </b>
                <xsl:value-of select="DName"/>
            </span>
        </td>
    ...
    <tr>
        <td>
            <span class="text">
                ...
                <xsl:value-of select="Doc[position()=1]/Summary/@sTime"/>
            </span>
        </td>
    </tr>
    <tr>
        <td>
            <span class="text">
                ...
                <xsl:value-of select="Doc[position()=last()]/Summary/@eTime"/>
            </span>
        </td>
    </tr>
    <xsl:if test="DVer">
    ...
    <tr>
        <td>
            <span class="text">
                ...
                <xsl:choose>
                    <xsl:when test="Doc/NodeArgs[@status = 'Failed']">
                        <xsl:copy-of select="$IDS_FAILED"/>
                    </xsl:when>
                    <xsl:when test="Doc/NodeArgs[@status = 'Warning']">
                        <xsl:copy-of select="$IDS_WARNING"/>
                    </xsl:when>
                    <xsl:when test="Doc/NodeArgs[@status = 'Passed']">
                        <xsl:copy-of select="$IDS_PASSED"/>
                    </xsl:when>
                    <xsl:otherwise>
                        <xsl:copy-of select="$IDS_DONE"/>
                    </xsl:otherwise>
                </xsl:choose>
            </span>
        </td>
        ...
        <td bgcolor="white">
            <table border="0" cellpadding="3" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td width="50%" valign="middle" align="center" height="20">
                        <span class="text">
                            <xsl:value-of select="sum(Doc/Summary/@passed)"/>
                        </span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="50%" valign="middle" align="center" height="20">
                        <span class="text">
                            <xsl:value-of select="sum(Doc/Summary/@failed)"/>
                        </span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="50%" valign="middle" align="center" height="20">
                        <span class="text">
                            <xsl:value-of select="sum(Doc/Summary/@warnings)"/>
                        </span>
                    </td>
                </tr>
                <tr>
