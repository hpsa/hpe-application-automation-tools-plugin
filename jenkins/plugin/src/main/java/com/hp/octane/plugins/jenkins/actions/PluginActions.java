...
import com.hp.nga.dto.general.AggregatedStatusInfo;
import com.hp.nga.dto.general.CIServerTypes;
import com.hp.nga.dto.general.PluginInfo;
import com.hp.nga.dto.parameters.ParameterType;
import com.hp.nga.dto.projects.ProjectsList;
...
public class PluginActions implements RootAction {
	...
	public void doStatus(StaplerRequest req, StaplerResponse res) throws IOException, ServletException {
		...
		statusInfo.setServer(new com.hp.nga.dto.general.ServerInfo(
	...
	private ProjectsList getProjectsList(boolean areParametersNeeded) {
		...
		for (String name : itemNames) {
			...
			if (areParametersNeeded) {
				...
				List<com.hp.nga.dto.parameters.ParameterConfig> configs = new ArrayList<com.hp.nga.dto.parameters.ParameterConfig>();
				for (ParameterConfig pc : tmpList) {
					configs.add(new com.hp.nga.dto.parameters.ParameterConfig(
				...
				tmpConfig.setParameters(configs.toArray(new com.hp.nga.dto.parameters.ParameterConfig[configs.size()]));
			}
			list.add(tmpConfig);
		}
