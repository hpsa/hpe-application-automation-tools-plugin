...
public class PluginActionsTest {
	...
	public void testPluginActions_REST_Jobs_WithParams() throws IOException, SAXException {
		...
		assertEquals(com.hp.nga.dto.parameters.ParameterType.BOOLEAN, response.getJobs()[0].getParameters()[0].getType());
		...
		assertEquals(com.hp.nga.dto.parameters.ParameterType.STRING, response.getJobs()[0].getParameters()[1].getType());
		...
		assertEquals(com.hp.nga.dto.parameters.ParameterType.FILE, response.getJobs()[0].getParameters()[2].getType());
