...
public class AlmLabEnvPrepareTaskConfigurator extends AbstractTaskConfigurator {
	...
	private static final String ENV_CONFIG = "envConfig";
	private static final String ENV_CONF_ITEMS = "envConfigItems";
	private static final String ENV_CONF_VALUE = "envConfValue";
	private static final String NONE_INDEX = "1";
